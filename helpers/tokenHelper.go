...
import (
	...
	"github.com/avatarnguyen/golang_jwt/database"
...
func GenerateAllTokens(email string, firstName string, lastName string, userType string, uid string) (signedToken string, signedRefreshToken string, error error) {
